...
INTEREST_SHARE = 25
GUARANTORS_INTEREST = 65
MIN_MPESA = 100
MAX_MPESA = 40000
MIN_NUM_CIRCLE_MEMBER = 5
MIN_SUBSEQUENT_SHARES = 1
MAX_CIRCLE_MEMBER = 1000
REFERRAL_FEE = 10
FRIDAY_REFERRAL_FEE = 50
...
APP_STORE_LINK = "https://goo.gl/5KWXhx"

RAVEN_CONFIG = {
    'dsn': 'https://ff99b8fc851e4df39074a139742b54ae:d7274c6358e2453181728904076cdcab@sentry.io/1263389',
    # If you are using git, you can also automatically configure the
    # release based on the git info.
    'release': raven.fetch_git_sha(os.path.abspath(os.path.join(os.path.dirname(__file__), os.path.pardir))),
}
