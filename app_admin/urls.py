...
urlpatterns = [
    ...
    url(r'^members/(?P<offset>[0-9]+)/$', views.members_page, name='members'),
    ...
    url(r'^wallet_transactions/(?P<offset>[0-9]+)/$', views.wallet_transactions, name='wallet_transactions'),
    ...
    url(r'^mpesa_transactions/(?P<offset>[0-9]+)/$', views.mpesa_transactions, name='mpesa_transactions'),
    url(r'^search_for_mpesa_transaction$', views.search_for_mpesa_transaction, name='search_for_mpesa_transaction'),
    url(r'^view_mpesa_transaction/(?P<transaction_code>[A-Za-z0-9]+)/$',
            views.view_mpesa_transaction, name='view_mpesa_transaction'),
    ...
    url(r'^financial_stmt$', views.financial_stmt, name='financial_stmt'),
    url(r'^cash_flow$', views.cash_flow, name='cash_flow'),
