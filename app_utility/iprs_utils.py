...
class Iprs():
    ...
    def save_extracted_iprs_info(self,new_member,person_data):
        member_info = { new_key : person_data.get(key) for new_key,key in {'nationality':'citizenship','gender':'gender','date_of_birth':'dateOfBirth','iprs_image_url':'photoPath'}.items()}
